...
for dr in dirnames:
    ...
    for fn in dirlist:
        ...
        if '[LABEL' in fn:
            ...
            fn2 = fn.lower()
            lmatch = cur.execute("select label from labels WHERE UPPER(label) ='{}'" .format(label33.upper()))
            if lmatch > 0:
                print('match ->'+label33)
                label2 = label33
    ...
    try:
        ...
        print(label3)
        labeldir = '/jail/ftpd/site/sorted/label/residentadvisor'
        ...
        cmd1 = 'ln -s /site/MP3/{}/{}/{} /jail/ftpd/site/sorted/label/residentadvisor/{}/{}/{}/{}/{}' .format(year, date, \
